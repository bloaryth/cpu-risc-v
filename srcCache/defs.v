...
`define Present			1'b1
`define NotPresent		1'b0
`define Miss			1'b1			//cache miss and read
`define Hit				1'b0			//cache hit and do not read
`define Rewrite			1'b1
`define NotRewrite		1'b0
`define TagSize			20				
`define TagBus			19:0			//Tag
`define IndexSize		10				
// `define PowIndex		1024
`define PowIndexBus		0:1023
`define IndexBus		9:0				//Index
`define SeletSize		2
`define SelectBus		1:0				//Byte Select - pad 3'b0
`define CacheSize		32				//4 Byte
`define CacheBus		31:0			
